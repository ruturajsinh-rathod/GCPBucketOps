...
from sqlalchemy import func, Enum as SqlEnum, text
...
class FileModel(Base):
    ...
    @classmethod
    def create(cls, file_name: str, gcs_uri: str, bucket_name: str,
               status: FileStatusEnum, size: int | None = None,
               content_type: str | None = None, public_url: str | None = None,
